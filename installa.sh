#!/bin/bash
# ============================================================
#  Lettore listino CHF Patek — installazione su Oracle Zurigo
#  Uso:  sudo bash installa.sh ch.tuodominio.com
#  Installa: servizio di lettura + Caddy con HTTPS automatico
# ============================================================
set -e

DOMINIO="$1"
if [ -z "$DOMINIO" ]; then
  echo "Manca il dominio. Esempio: sudo bash installa.sh ch.tuodominio.com"
  exit 1
fi
...
echo ">>> Installazione Caddy (HTTPS automatico)"
...
echo ">>> Apertura porte nel firewall della macchina"
...
echo "=========================================="
echo "  FATTO"
echo "  Prova:  https://${DOMINIO}/?u=https://www.patek.com/en/collection/nautilus/5811-1g-001"
echo "  Deve rispondere con \"valuta\":\"CHF\""
echo "=========================================="
